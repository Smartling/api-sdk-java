...
/**
 * The data expected back in the response to getting project locales query of the Smartling Translation API.
 */
public class ProjectLocaleList implements Data
{
    ...
    public void setLocales(final List<ProjectLocale> locales)
    {
